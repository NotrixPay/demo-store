...
export const metadata: Metadata = {
  title: "Demo Store",
  description: "Demo Store For Integration Display",
};
      ...
      <body className={`${inter.className} h-screen`}>
        ...
        <footer className="footer items-center p-4 bg-neutral text-neutral-content flex justify-between">
          <aside className="items-center grid-flow-col">
            ...
            <p>Copyright © 2024 Notrix - All right reserved</p>
          </aside>
          <Link href="https://notrix.io" className="btn btn-accent flex items-center">Try Notrix Payments</Link>
        </footer>
      </body>
    </html>
  );
